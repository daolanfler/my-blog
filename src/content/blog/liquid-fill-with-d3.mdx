...
在线示例可以访问 [Observehq Notebook](https://observablehq.com/d/70713e198a9a835b)

{/* right click element and select embed to copy the iframe url on Observable*/}
<iframe width="100%" height="234" frameborder="0"
  title="Liquid Fill Gauge"
  src="https://observablehq.com/embed/70713e198a9a835b?cells=element"></iframe>
